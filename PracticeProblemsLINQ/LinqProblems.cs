...
namespace PracticeProblemsLINQ
{
    public static class LinqProblems
    {
        ...
        {
            //code
            IEnumerable<string> thWords = words.Where(th => th.Contains("th"));
            //return
            return thWords.ToList();
        }
        #endregion
        ...
        public static List<string> RunProblem2(List<string> names)
        {
            ...
            //foreach (var i in distinctNames)  ////to print to console the names
            //{
            //    Console.WriteLine(i);    
            //}
            //Console.ReadLine();
        ...
        //{
        //    //code
        //    var mikeNames = customers.Where(m => m.FirstName.Equals("Mike"));
